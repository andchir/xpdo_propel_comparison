...
abstract class Book implements ActiveRecordInterface
{
    ...
    public function setPubDate($v)
    {
        ...
        if ($this->pub_date !== $v) {
            $this->pub_date = $v;
            $this->modifiedColumns[BookTableMap::COL_PUB_DATE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : BookTableMap::translateFieldName('PubDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pub_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : BookTableMap::translateFieldName('Price', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BookTableMap::COL_PUB_DATE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BookTableMap::COL_PUB_DATE)) {
            $criteria->add(BookTableMap::COL_PUB_DATE, $this->pub_date);
        }
        if ($this->isColumnModified(BookTableMap::COL_PRICE)) {
