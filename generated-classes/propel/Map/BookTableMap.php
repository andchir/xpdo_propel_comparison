...
class BookTableMap extends TableMap
{
     ...
     */
    const COL_PUB_DATE = 'book.pub_date';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'ISBN', 'PubDate', 'Price', 'PublisherId', 'AuthorId', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'iSBN', 'pubDate', 'price', 'publisherId', 'authorId', ),
        self::TYPE_COLNAME       => array(BookTableMap::COL_ID, BookTableMap::COL_TITLE, BookTableMap::COL_ISBN, BookTableMap::COL_PUB_DATE, BookTableMap::COL_PRICE, BookTableMap::COL_PUBLISHER_ID, BookTableMap::COL_AUTHOR_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'isbn', 'pub_date', 'price', 'publisher_id', 'author_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'ISBN' => 2, 'PubDate' => 3, 'Price' => 4, 'PublisherId' => 5, 'AuthorId' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'iSBN' => 2, 'pubDate' => 3, 'price' => 4, 'publisherId' => 5, 'authorId' => 6, ),
        self::TYPE_COLNAME       => array(BookTableMap::COL_ID => 0, BookTableMap::COL_TITLE => 1, BookTableMap::COL_ISBN => 2, BookTableMap::COL_PUB_DATE => 3, BookTableMap::COL_PRICE => 4, BookTableMap::COL_PUBLISHER_ID => 5, BookTableMap::COL_AUTHOR_ID => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'isbn' => 2, 'pub_date' => 3, 'price' => 4, 'publisher_id' => 5, 'author_id' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('pub_date', 'PubDate', 'INTEGER', true, 20, null);
        $this->addColumn('price', 'Price', 'INTEGER', true, 20, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(BookTableMap::COL_PUB_DATE);
